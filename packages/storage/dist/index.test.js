...
import { StorageService, createStorageService, getStorageService, resetStorageService, } from './index.js';
...
describe('Integration scenarios', () => {
    ...
    it('should handle full pin -> verify workflow', async () => {
        ...
        // Verify integrity
        const verifyResult = storage.verify(payload, pinResult.sha256, pinResult.signature);
